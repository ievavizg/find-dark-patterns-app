...
const strings = new LocalizedStrings({
  en: {
    ...
    register: {
      ...
      descHelperText:"Please describe where You have spotted Dark Patterns in the website",
      typeLabel: 'Type',
      typeHelperText: 'Please enter the type of Dark Pattern if You think You know',
      avoidanceLabel:"Avoidance",
      avoidanceHelperText:"Please enter how You think user could avoid Dark Pattern",
      emailLabel:"Email",
      emailHelperText:"Please enter Your email in case we would need some additional information",
    }
  },
  lt: {
    buttons: {
    ...
    patterns: {
      ...
      friendSpamDesc: {
        main:
          "Produktas prašo el. pašto ar socialinių tinklų teisių apsimetant, kad jis bus naudojamas naudotojui naudingais tikslais (pvz. surasti draugus), bet tuomet visus gautus kontaktus iš nukentėjusio atakuoja pranešimais, kurie tariamai buvo siųsti pačio nukentėjusio.",
      },
      disguisedAds: "Užmaskuota reklama",
      disguisedAdsDesc: {
        main:
          "Reklamos, kurios užmaskuotos kaip kitokio tipo turinys ar nukreipimas, kuriomis siekiama, kad naudotojas paspaustų ant jų.",
      },
      forced: "Priverstinis tęstinumas",
      forcedDesc: {
        main:
          "Apgaulingojo šablono tipas, kuomet pasibaigus bandomajam laikotarpiui, be jokio perspėjimo pradedami nuskaičiuoti pinigai iš pridėtos kortelės, sąskaitos ir pan. Kai kuriais atvejais dar ir yra apsunkinama galimybė atsisakyti paslaugų.",
      },
      bait: "Masalas ir perėjimas",
      baitDesc: {
        main:
          "Siekiant atlikti vieną veiksmą, įvyksta kitas, ne tas, kurio buvo norima ir tikimasi.",
      },
      hidden: "Paslėpti mokesčiai",
      hiddenDesc: {
        main:
          "Atvykus į paskutinį apmokėjimo etapą, kaina išauga prisidėjus anksčiau nenurodytiems mokesčiams, pavyzdžiui, aptarnavimo mokesčiai ir pan.",
      },
      misdirection: "Neteisingas nukreipimas",
      misdirectionDesc: {
        main:
          "Sistemos dizainas specialiai fokusuoja naudotojo dėmesį į pasirinktą vietą, siekiant atitraukti dėmesį nuo kitos.",
      },
      priceComp: "Kainų palyginimo prevencija",
      priceCompDesc: {
        main:
          "Pardavėjas apsunkina prekių kainų palyginimą, todėl naudotojui sunkiau priimti pagrįstą sprendimą.",
      },
      zuck: "Privatumo Zuckeringas",
      zuckDesc: {
        main:
          "Naudotojas apgaunamas viešai pateikti daugiau informacijos apie save negu buvo planavęs. Pavadintas Facebook CEO Mark Zuckenberg vardu.",
      },
      roach: "Kuojos motelis",
      roachDesc: {
        main:
          "Dizainas sudaro labai palankias sąlygas naudotojui pakliūti į tam tikras situacijas, tačiau labai apsunkina iš jų išeiti, pavyzdžiui prenumeratos.",
      },
      sneak: "Sėlinimas į krepšelį ",
      sneakDesc: {
        main:
          "Apsipirkinėjimo metu puslapis nepastebimai prideda prekę į naudotojo krepšelį",
      },
      trickQuestions: "Klaidinantys klausimai",
      trickQuestionsDesc: {
        main:
          "Pateikiami klausimai, kuriuose iš pirmo žvilgsnio atrodo, jog klausia vieno, tačiau pasigilinus pasirodo, jog klausimas klausia visai ne to.",
      },
    },
    quiz: {
      heading: 'Viktorina: Kaip gerai esi susipažinęs su apgaulingaisiais šablonais?',
      score: 'Teisingai atsakei ',
    },
    register: {
      heading: 'Registruoti apgaulingąjį šabloną',
      urlLabel:"Svetainės adresas (URL)",
      urlHelperText:"Prašome pateikti svetainės, kurioje pastebėjote apgaulingąjį šabloną URL adresą",
      descLabel:"Apibūdinimas",
      descHelperText:"Prašome apibūdinti kurioje vietoje pastebėjote apgaulingąjį šabloną",
      typeLabel: 'Tipas',
      typeHelperText: 'Prašome įrašyti apgaulingojo šablono tipą, jei žinote',
      avoidanceLabel:"Išvengimas",
      avoidanceHelperText:"Prašome įrašyti kaip išvengti šio apgaulingojo šablono jei žinote",
      emailLabel:"El. paštas",
      emailHelperText:"Prašome pateikti savo el. pašto adresą, jei turėtume daugiau klausimų apie Jūsų pateiktą informaciją (neprivaloma)",
    },
  },
});
